    ...
    checkpoint transdecoder_longorfs:
        ...
        output:
            longestPep=join(
                ORFPREDICT_DIR,
                "transDecoder",
                "transcript.flt1.fa.transdecoder_dir",
                "longest_orfs.pep",
            ),
        log:
        ...
        run:
            ...
            LOG_ORFPRED.info(
                f"Extracted long open reading frames (ORFs) using TransDecoder.LongOrfs in {elapseTime:.2f} seconds."
            )
...
rule blastp_search:
    ...
    run:
        ...
        elapseTime = endTime - startTime
        LOG_ORFPRED.info(
            f"Performed BlastP search using Diamond blastp in {elapseTime:.2f} seconds."
        )
...
rule pfam_search:
    ...
    run:
        ...
        elapseTime = endTime - startTime
        LOG_ORFPRED.info(
            f"Performed Pfam domain search using hmmsearch in {elapseTime:.2f} seconds."
        )
...
checkpoint transdecoder_predict:
    ...
    run:
        ...
        elapseTime = endTime - startTime
        LOG_ORFPRED.info(
            f"Predicted likely coding regions using TransDecoder.Predict in {elapseTime:.2f} seconds."
        )
...
rule filter_step:
    ...
    run:
        ...
        elapseTime = endTime - startTime
        LOG_ORFPRED.info(
            f"Filtered transcripts based on TransDecoder.Predict output in {elapseTime:.2f} seconds."
        )
