    ...
    if PAIREDEND:
        rule fastqc:
            ...
            run:
                ...
                LOG_QUALCTRL.info(f"Performed quality check of {wildcards.sample} using FastQC in {elapseTime:.2f} seconds")
    else:
        rule fastqc:
            """ 
            Perform quality check using FastQC
    ...
    if PAIREDEND:
        rule fastqc:
            ...
            run:
                ...
                endTime = time()
                elapseTime = endTime - startTime
                LOG_QUALCTRL.info(f"Performed quality check using FastQC in {elapseTime:.2f} seconds")
    else:
        rule fastqc:
            """ 
            Perform quality check using FastQC
